...
\begin{document}
	...
	\noindent En este documento, recojo lo que sería mi memoria en relación al TFE. En dicho documento comentaremos los detallaremos las diferentes investigaciones realizadas sobre virtualización en sistemas Linux, como funcionan los contenedores y como utilizar virtualización ligera para la evaluación de redes de comunicaciones, en nuestro caso, de conmutación de paquetes.
	
	\subsection{Contexto del trabajo}
	\noindent Este proyecto nace con el objetivo de profundizar en conceptos tan importantes como pueden ser la virtualización, o los bien conocidos \textit{contenedores}. Además, particularizamos estas tecnologías y las acercamos al campo de la telemática para utilizarlas con el fin de evaluar y simular redes de conmutación de tipo IP. \\
	...
	\begin{itemize}
		\item Aprendes los conceptos básicos de NFV.
...
$ umount /var/uts-h1
	...
	\begin{itemize}
		\item NFV. \textit{Network Function Virtualization}, o bien, Virtualización de funciones de red.
