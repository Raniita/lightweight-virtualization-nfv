...
$ umount /var/uts-h1
	...
	\pagebreak
	\section{Anexo 1. Instalación de \texttt{ansible} para automatizar una VM}
	...
	\begin{enumerate}
		...
		\item Procedemos a copiar la clave pública SSH que hemos generado en el paso dos. Utilizamos el siguiente comando, sustituyendo con el usuario e IP específico de la máquina.
		\begin{verbatim}
