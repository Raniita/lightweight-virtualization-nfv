...
$ ip link set dev enp2s0.{num} up
	...
	% TODO Rehacer el diagrama. Un diagrama sin la conexion entre netns y otro diagrama con solo la conexion entre netns
	...
	% TODO explicar brevemente que los veth pairs se usan normalmente en los namespaces, que más adelante introduciremos
