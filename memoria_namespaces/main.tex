...
\	\subsection{Tecnologías implicadas}
	...
	\begin{figure}[h!]
		\begin{center}
			...
			\caption{Comparativa en capas OSI de las tecnologías NFV y SDN [\ref{bib: sdn y nfv}]}
			\label{img: sdn + nfv}
		\end{center}
	\end{figure}
...
$ ip netns exec app2 ip link set lo up
	...
	\noindent \large \textbf{TUN (Capa 3)}\\
	...
	\noindent \large \textbf{TAP (Capa 2)}\\
