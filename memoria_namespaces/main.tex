...
> arch-linux
	...
	%% TODO: REVISION ENERO
	%% Distinguir entre un device  (/dev) y una estructura de directorios que se emulan a modo de device
...
mininet> h1 ping h2
	...
	\noindent Por lo tanto, a modo de ejemplo, vamos a utilizar la topología anterior, pero aplicando una limitación de ancho de banda, latencia y CPU a uno de los enlaces que conectan un host con el switch.
...
ansible/install.yml
	...
	\begin{figure}[h!]
		\begin{center}
			\includegraphics[width=0.9\textwidth]{img/cn_example1.png}
			\caption{Topologia simple (1/5)}
		\end{center}
	\end{figure}

	\begin{figure}[h!]
		\begin{center}
			\includegraphics[width=0.5\textwidth]{img/cn_example2.png}
			\caption{Topologia simple (2/5)}
		\end{center}
	\end{figure}
	...
	\begin{figure}[h!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{img/cn_example3.png}
			\caption{Topologia simple (3/5)}
		\end{center}
	\end{figure}
	...
	\begin{figure}[h!]
		\begin{center}
			\includegraphics[width=0.9\textwidth]{img/cn_example4.png}
			\caption{Topologia simple (4/5)}
		\end{center}
	\end{figure}
...
192.168.1.200
	...
	\subsection*{Anexo 4. Topologías de \texttt{mininet}}
	\label{sec: anexo 4}
	...
	\begin{lstlisting}[language=Python, caption={Implementación topología simple utilizando mininet}, label={lst: topo simple}]
