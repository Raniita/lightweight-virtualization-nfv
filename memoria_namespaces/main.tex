...
lxc.id_map = g 0 100000 65536
	...
	\noindent \textbf{\large Tecnología utilizada por \texttt{Docker}}\\
...
sudo docker version
	...
	\noindent El comando nos devovlerá información sobre el cliente de docker e intentará conectar con el ``demonio''. En el caso de que nos responda como en la imagen (\ref{img: docker version}), tendremos que ejecutar el comando:
	\begin{verbatim}
