...
$ umount /var/uts-h1
	...
	\noindent En el caso de que queramos utilizar la herramienta ansible para configurar una VM [\ref{bib:install ansible}], tendremos que seguir los siguientes pasos.
	\begin{enumerate}
